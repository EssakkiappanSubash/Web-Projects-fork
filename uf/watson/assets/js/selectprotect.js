...
// const proContainer = document.querySelector('.protect--container');
...
product1.addEventListener( 'click', () => {
    ...
    proOnClick.style.display = 'block';

    // document.querySelector('#eye-multi').classList.toggle('protect--container-onclick');
    // document.querySelector('#eye-health').classList.toggle('protect--container-offclick');
    // document.querySelector('#eyelid-wipes').classList.toggle('protect--container-offclick');
    // document.querySelector('#ear-wipes').classList.toggle('protect--container-offclick');
    // document.querySelector('#ear-wash').classList.toggle('protect--container-offclick');
    // document.querySelector('#eye-wash').classList.toggle('protect--container-offclick');
})
...
product2.addEventListener( 'click', () => {
    ...
    // document.querySelector('#eye-health').classList.toggle('protect--container-onclick');
    // document.querySelector('#eye-multi').classList.toggle('protect--container-offclick');
    // document.querySelector('#eyelid-wipes').classList.toggle('protect--container-offclick');
    // document.querySelector('#ear-wipes').classList.toggle('protect--container-offclick');
    // document.querySelector('#ear-wash').classList.toggle('protect--container-offclick');
    // document.querySelector('#eye-wash').classList.toggle('protect--container-offclick');
...
product3.addEventListener( 'click', () => {
    ...
    // document.querySelector('.protect--container').classList.toggle('protect--container-onclick');
})
